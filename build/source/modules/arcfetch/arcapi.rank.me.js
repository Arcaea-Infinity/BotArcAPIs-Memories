...
const TAG = 'arcapi.rank.me.ts';
const syslog_1 = __importDefault(require("../syslog/syslog"));
const arcfetch_1 = __importStar(require("./arcfetch"));
exports.default = (account, songid, difficulty, start = 4, limit = 18) => {
    return new Promise((resolve, reject) => {
        const _remote_request = new arcfetch_1.ArcFetchRequest(arcfetch_1.ArcFetchMethod.GET, 'score/song/me', {
...
//# sourceMappingURL=arcapi.rank.me.js.map