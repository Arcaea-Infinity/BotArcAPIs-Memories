...
const TAG = 'arcapi.any.ts';
const syslog_1 = __importDefault(require("../syslog/syslog"));
const arcfetch_1 = __importStar(require("./arcfetch"));
exports.default = (account, method, path, databody) => {
    const _remote_request = new arcfetch_1.ArcFetchRequest(method, path, {
...
//# sourceMappingURL=arcapi.any.js.map