...
const TAG = 'arcapi.friend.add.ts';
const syslog_1 = __importDefault(require("../syslog/syslog"));
const arcfetch_1 = __importStar(require("./arcfetch"));
exports.default = (account, usercode) => {
    return new Promise((resolve, reject) => {
        const _remote_request = new arcfetch_1.ArcFetchRequest(arcfetch_1.ArcFetchMethod.POST, 'friend/me/add', {
...
//# sourceMappingURL=arcapi.friend.add.js.map