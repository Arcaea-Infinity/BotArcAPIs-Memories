...
const TAG = 'arcapi.rank.world.ts';
const syslog_1 = __importDefault(require("../syslog/syslog"));
const arcfetch_1 = __importStar(require("./arcfetch"));
exports.default = (account, songid, difficulty, start = 0, limit = 20) => {
    return new Promise((resolve, reject) => {
        const _remote_request = new arcfetch_1.ArcFetchRequest(arcfetch_1.ArcFetchMethod.GET, 'score/song', {
...
//# sourceMappingURL=arcapi.rank.world.js.map