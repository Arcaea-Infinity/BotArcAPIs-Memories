...
const feed_managed_1 = __importDefault(require("../../../modules/account/feed.managed"));
exports.default = (argument, method, path, header, databody) => {
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            let _time = 0;
            try {
                _time = yield feed_managed_1.default(_access_token);
            }
            catch (e) {
                throw new apierror_1.default(-2, 'feed token failed');
            }
