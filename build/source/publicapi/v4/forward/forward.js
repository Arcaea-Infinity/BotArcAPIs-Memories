...
const arcapi_any_1 = __importDefault(require("../../../modules/arcfetch/arcapi.any"));
const fromtoken_1 = __importDefault(require("../../../modules/account/fromtoken"));
exports.default = (argument, method, path, header, databody) => {
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            let _account = null;
            try {
                _account = yield fromtoken_1.default(_access_token);
            }
            catch (e) {
            ...
            if (BOTARCAPI_FORWARD_WHITELIST
                ...
                if (!pass)
                    throw new apierror_1.default(-3, 'illegal forward url');
            }
            let _return = {};
            try {
                _return = yield arcapi_any_1.default(_account, method, path + '?' + new URLSearchParams(argument), databody);
            }
            catch (e) {
